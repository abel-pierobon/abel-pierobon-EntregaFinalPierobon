...
function Item({ articulo }) {
    return (
        ...
        >
            ...
            <div className=''>
                <h2 className="font-black truncate">Guitarra {articulo.marca}</h2>
                ...
                {articulo.available_quantity === 0 ? (
                    ...
                    <p className='flex justify-center text-sm md:text-md text-red-500 font-black'>ÚLTIMAS UNIDADES</p>
                ) : (
                    <p className="flex justify-center font-black text-green-700"> EN STOCK</p>
                )}
